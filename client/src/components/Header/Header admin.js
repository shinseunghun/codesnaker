                ...
                <div className="h_nav ct1 af">
                    ...
                    <ul className="af">
                        <li className="menulist">
                            <Link to={'/Userwinner'}>사용자 랭킹</Link>
                        </li>
                        <li className="menulist">
                            <Link to={'/ResearchProject'}>신규 알고리즘</Link>
                        </li>
                        <li className="menulist">
                            <Link to={'/SellProject'}>추천 알고리즘</Link>
                        </li>
                        <li className="menulist">
                            <Link to={'/AdminDataSourceList'}>결제 관리</Link>
                        </li>
                        {/* 드롭다운 이벤트 */}
                        <li  className="menulist"><Link to={'/floatPopulationList'}>관리자 메뉴</Link>
                        <ul className="gn_2">
                            <li><Link to={'/community/notice'}>공지사항</Link></li>
                        </ul>
                        </li>
                        <li  className="menulist">
                            <Link to={'/SubCodeManage'}>관리자 관리</Link>
                        </li>
                    </ul>
                    </nav>
                </div>
